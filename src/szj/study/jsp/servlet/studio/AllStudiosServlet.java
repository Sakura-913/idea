...
@WebServlet("/allStudios")
public class AllStudiosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            // 获取数据
            int totalRecord = studioService.getTotalStudios(searchKeyword);
            List<Studio> studios = studioService.getStudiosByPage(pageNum, pageSize, searchKeyword);
            ...
            // 转发到JSP
            req.getRequestDispatcher("/allStudios.jsp").forward(req, resp);
            
        } catch (Exception e) {
            System.out.println("获取工作室列表失败: " + e.getMessage());
            resp.sendRedirect("allStudios?pageNum=1");
        }
    }
